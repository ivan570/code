<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_login.aspx.cs" Inherits="final_done_now.student.student_login" %>
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.html">
                        <h1 class="text-lg-center text-light">Student Login</h1>
                    </a>
                </div>
            ...
            <h4  class="text-lg-center text-left m-1"><a href="student_registration.aspx"> Register</a></h4>
                </div>
            </div>
        </div>
    </div>
