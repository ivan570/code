<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student_registration.aspx.cs" Inherits="final_done_now.student.student_registration" %>
...
<body class="bg-dark">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <h1 class="text-lg-center text-light">Student Registration
                    </h1>
                </div>
    ...
    <script type="text/javascript">
        var your_site_key = '6LeDYzQaAAAAAENPmVKe44quJUfGgE22Oj8wbFR2';
        var renderRecaptcha = function () {
            grecaptcha.render('ReCaptchContainer', {
                'sitekey': '6LeDYzQaAAAAAENPmVKe44quJUfGgE22Oj8wbFR2',
